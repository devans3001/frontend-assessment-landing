...
function Hero() {
  return (
    <div className="relative min-h-screen pt-15 overflow-hidden flex items-center justify-center ">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative animate-fade-in-slow">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-card-hover w-full lg:max-w-[600px] aspect-[16/9]">
            <Image
