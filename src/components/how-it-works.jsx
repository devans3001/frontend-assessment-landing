...
//   console.log(val);
  return (
    <div
      className="py-16 flex flex-col items-center gap-4 justify-center"
    ...
    >
      ...
      <div className="grid md:grid-cols-4 gap-8 relative">
        {[
          ...
          >
            <div
              className="relative w-32 h-32 rounded-full z-10 bg-gradient-to-br from-royal-blue via-electric-blue to-aqua flex justify-center items-center p-1"
